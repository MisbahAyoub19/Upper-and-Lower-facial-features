...
vidFolder = 'C:/Users/M.Ayoub19/PycharmProjects/Emotion recognition/2024/Sep'

datasetFolder = os.path.join(vidFolder, 'C:/Users/M.Ayoub19/PycharmProjects/Emotion recognition/2024/Sep/ADFES')
videoFiles = glob.glob(os.path.join(datasetFolder, '*.mp4'))
