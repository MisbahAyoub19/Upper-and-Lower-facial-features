...
def Frame(detector,predictor, shapePoints, borders, Video_path,PicturePath,imgPaths,SheetPath,FeaturesPath,ResultPath,vidFolder, frame_rate):
        ...
        if ret == True:
            ...
            if(lenDets>0):
                ...
                # Modify the call to return 2 values
                    (framOut, blinkOut, left_eyeratio, right_eyeratio, left_eb_distance, right_eb_distance) = roi_v2_LDA.rect1(predictor, i, shotname, picturepath,
                                                                   imgPaths[featCount], SheetPath, FeaturesPath, shapePoints[featCount], borders[featCount], frame,
                                                                   dets)
